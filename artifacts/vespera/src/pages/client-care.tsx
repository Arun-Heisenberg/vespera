      ...
      <section className="w-full px-5 md:px-10 py-8 md:py-12 max-w-5xl mx-auto">
        ...
        >
          ...
          <div className="flex items-center justify-center gap-8">
            <a href="https://www.instagram.com/classyclutch16?igsh=cGo5OGdxb2FsZWNq" target="_blank" rel="noopener noreferrer" className="text-foreground/30 hover:text-primary transition-colors duration-300" aria-label="Instagram">
            ...
            <a href="https://www.facebook.com/share/1DP1GcGz7B/" target="_blank" rel="noopener noreferrer" className="text-foreground/30 hover:text-primary transition-colors duration-300" aria-label="Facebook">
