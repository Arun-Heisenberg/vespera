        ...
        {isMenuOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 left-0 h-full w-full sm:w-[420px] bg-background z-[70] flex flex-col overflow-y-auto scrollbar-none"
            >
              ...
              <nav className="flex-1 px-6 md:px-8 py-6">
                <motion.div
        ...
        <div className="relative py-8 md:py-10 luxury-noise">
          ...
          <div className="w-full px-5 md:px-10 flex flex-col items-center relative z-10">
            ...
            <div className="flex items-center gap-8 mb-5">
              <a href="https://www.instagram.com/classyclutch16?igsh=cGo5OGdxb2FsZWNq" target="_blank" rel="noopener noreferrer" className="text-muted-foreground/40 hover:text-primary transition-colors duration-300" aria-label="Instagram">
              ...
              <a href="https://www.facebook.com/share/1DP1GcGz7B/" target="_blank" rel="noopener noreferrer" className="text-muted-foreground/40 hover:text-primary transition-colors duration-300" aria-label="Facebook">
