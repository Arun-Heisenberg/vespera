        ...
        <div className="w-full px-5 md:px-10 flex items-center justify-between">
          ...
          <Link href="/" className="absolute left-1/2 -translate-x-1/2">
            <img 
              src="/logo.png" 
              alt="Vespera" 
              className="h-8 md:h-10 object-contain brightness-125"
              onError={(e) => {
        ...
        <div className="relative py-12 md:py-16 luxury-noise">
          ...
          <div className="w-full px-5 md:px-10 flex flex-col items-center relative z-10">
            ...
            <div className="flex items-center gap-6 mb-8">
              <span className="text-[10px] tracking-[0.2em] uppercase text-muted-foreground/30 font-light">Follow Us</span>
              <div className="gold-divider flex-1 min-w-[20px]" />
            </div>
